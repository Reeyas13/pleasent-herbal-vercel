    ...
    return (
        <div className="text-center mt-8">
            ...
            <ul className="flex justify-center mt-5 space-x-5">
                <li>
                    <a href="https://www.facebook.com/rohan.karki.90813/" className="text-gray-500 hover:text-gray-900">
                ...
                <li>
                    <a href="https://github.com/Reeyas13" className="text-gray-500 hover:text-gray-900">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fillRule="evenodd"
